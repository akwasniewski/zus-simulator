      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mt-12">
          <p className="text-foreground mb-4">
            Chcesz dokładniejszą symulację?
          </p>
          <button className="bg-orange text-foreground px-8 py-3 rounded-lg font-semibold hover:bg-[#FF9800] transition-colors">
            Przejdź do szczegółowego symulatora
          </button>
        </div>
      </div>
    </div>
